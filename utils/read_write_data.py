...
class read_write_data():
    ...
    def benchmark_csv(self, read_index):
        ...
        precision = data['Precision'][read_index]
        ...
        return model_name, self.num_devices, precision, model_input, batch_size_gpu, batch_size_dla
    def __len__(self):
    ...
    def read_window_results(self, models):
        ...
        for e_id in range(0, self.num_devices):
            ...
            read_file = os.path.join(self.model_path, model_device_name + '.txt')
        ...
        try:
            ...
            pass
        print("readWriteData: GPU:{}, DLA0:{}, DLA1:{}".format(lpd[0], lpd[1], lpd[2]))
